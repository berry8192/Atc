    ...
    rep(i, m) {
        ...
        if (d[i] == 'U') {
            if (xh.find(sx) != xh.end()) {
                auto itr = xh[sx].lower_bound(sy);
                while (itr != xh[sx].end() && *itr <= sy + c[i]) {
                    reached.push_back(*itr);
                    ans++;
                    itr++;
                }
                rep(i, reached.size()) {
                    xh[sx].erase(reached[i]);
                    yh[reached[i]].erase(sx);
                }
            }
            sy += c[i];
        } else if (d[i] == 'L') {
            if (yh.find(sy) != yh.end()) {
                auto itr = yh[sy].lower_bound(sx - c[i]);
                while (itr != yh[sy].end() && *itr <= sx) {
                    // cout << "! " << *itr SP << sy << endl;
                    reached.push_back(*itr);
                    ans++;
                    itr++;
                ...
                rep(i, reached.size()) {
                    // cout << "!  " << reached[i] SP << sy << endl;
                    yh[sy].erase(reached[i]);
                    xh[reached[i]].erase(sy);
                }
            }
            sx -= c[i];
        } else if (d[i] == 'R') {
            if (yh.find(sy) != yh.end()) {
                auto itr = yh[sy].lower_bound(sx);
                while (itr != yh[sy].end() && *itr <= sx + c[i]) {
                    reached.push_back(*itr);
                    ans++;
                    itr++;
                }
            ...
            if (xh.find(sx) != xh.end()) {
                auto itr = xh[sx].lower_bound(sy - c[i]);
                while (itr != xh[sx].end() && *itr <= sy) {
                    reached.push_back(*itr);
                    ans++;
                    itr++;
                }
        ...
        // cout << sx SP << sy SP << ans << endl;
        // cout << xh.size() SP << yh.size() << endl;
    }
