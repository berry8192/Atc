        ...
        PROCEDURE        DIVISION.
            ...
            *>結果を出力
               ...
               FUNCTION NUMVAL(WORK-ITEM(3))) THEN
                   IF(FUNCTION NUMVAL(WORK-ITEM(2)) <=
                   FUNCTION NUMVAL(WORK-ITEM(4))) THEN
                       IF(FUNCTION NUMVAL(WORK-ITEM(3)) <= 
                       FUNCTION NUMVAL(WORK-ITEM(2))) THEN
                           ADD 1 TO ANS
                       END-IF
                   ELSE
                       IF(FUNCTION NUMVAL(WORK-ITEM(3)) <= 
