...
int main() {
    ...
    cin >> sx >> sy >> tx >> ty;
    sx += 1000000000000000000LL;
    tx += 1000000000000000000LL;
    sy += 1000000000000000000LL;
    ty += 1000000000000000000LL;
    ...
    // cout << st SP << tt SP << ans << endl;

    if (sy % 2 == ty % 2) {
        ll xdis = abs(st - tt);
        ans = max(0LL, xdis - ans / 2) + ans;
    } else {
        ans -= 1;
        if (sy % 2 == 0) {
            ll xdis = abs(st - tt);
            ll xdis2 = abs(st + 1 - tt);
            ans = max(0LL, min(xdis - ans / 2, xdis2 - ans / 2)) + ans + 1;
        } else {
            ll xdis = abs(st - tt);
            ll xdis2 = abs(st - 1 - tt);
            ans = max(0LL, min(xdis - ans / 2, xdis2 - ans / 2)) + ans + 1;
