    ...
    rep(i, h) {
        rep(j, w) {
            ...
            while (!qh.empty()) {
                ...
                seen[ch * 1000 + cw] = 1;
                if (ch > 0 && seen[(ch - 1) * 1000 + cw] == 0 &&
                    s[ch - 1][cw] != '#') {
                    qh.push(ch - 1);
                    qw.push(cw);
                }
                if (cw > 0 && seen[ch * 1000 + cw - 1] == 0 &&
                    s[ch][cw - 1] != '#') {
                    qh.push(ch);
                    qw.push(cw - 1);
                }
                if (ch < h - 1 && seen[(ch + 1) * 1000 + cw] == 0 &&
                    s[ch + 1][cw] != '#') {
                    qh.push(ch + 1);
                    qw.push(cw);
                }
                if (cw < w - 1 && seen[ch * 1000 + cw + 1] == 0 &&
                    s[ch][cw + 1] != '#') {
                    qh.push(ch);
                    qw.push(cw + 1);
                }
